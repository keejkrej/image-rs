...
use image_model::{CoreError, DatasetF32, Metadata};
use image_commands::{MeasurementTable, Operation, OpsError, execute_operation_with_registry};
...
mod tests {
    ...
    use image_commands::{Operation, default_registry};
    use ndarray::Array;
    use serde_json::json;
