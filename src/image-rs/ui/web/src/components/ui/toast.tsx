...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Root
    ref={ref}
    className={cn(
      "group pointer-events-auto relative flex w-full items-start space-x-2 overflow-hidden rounded-md border bg-background p-4 shadow-lg",
      className
    )}
    {...props}
  />
...
export { ToastProviderPrimitive, ToastViewport, Toast, ToastTitle, ToastDescription };
